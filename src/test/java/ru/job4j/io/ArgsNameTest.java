...
class ArgsNameTest {
    ...
    void whenThereNoEqualSign() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-key512"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Error: This argument '-key512' does not contain an equal sign");
    }
    ...
    @Test
    void whenNoHyphenPrefixIsAbsent() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-key=value", "key1=value="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument 'key1=value=' does not start with a '-' character");
    }
}